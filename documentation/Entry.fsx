...
let HomePage: obj =
    rl (fun () -> importDynamic "./Home.fsx")

let AlertSample: obj =
    rl (fun () -> importDynamic "./Components/AlertSample.fsx")

let BadgeSample: obj =
    rl (fun () -> importDynamic "./Components/BadgeSample.fsx")

let BreadcrumbsSample: obj =
    rl (fun () -> importDynamic "./Components/BreadcrumbsSample.fsx")

let ButtonDropdownSample: obj =
    rl (fun () -> importDynamic "./Components/ButtonDropdownSample.fsx")

let ButtonGroupSample: obj =
    rl (fun () -> importDynamic "./Components/ButtonGroupSample.fsx")

let ButtonsSample: obj =
    rl (fun () -> importDynamic "./Components/ButtonsSample.fsx")

let CardSample: obj =
    rl (fun () -> importDynamic "./Components/CardSample.fsx")

let CarouselSample: obj =
    rl (fun () -> importDynamic "./Components/CarouselSample.fsx")

let CollapseSample: obj =
    rl (fun () -> importDynamic "./Components/CollapseSample.fsx")

let DropdownsSample: obj =
    rl (fun () -> importDynamic "./Components/DropdownsSample.fsx")

let FadeSample: obj =
    rl (fun () -> importDynamic "./Components/FadeSample.fsx")

let FormSample: obj =
    rl (fun () -> importDynamic "./Components/FormSample.fsx")

let InputGroupSample: obj =
    rl (fun () -> importDynamic "./Components/InputGroupSample.fsx")

let JumbotronSample: obj =
    rl (fun () -> importDynamic "./Components/JumbotronSample.fsx")

let LayoutSample: obj =
    rl (fun () -> importDynamic "./Components/LayoutSample.fsx")

let ListGroupSample: obj =
    rl (fun () -> importDynamic "./Components/ListGroupSample.fsx")

let MediaSample: obj =
    rl (fun () -> importDynamic "./Components/MediaSample.fsx")

let ModalsSample: obj =
    rl (fun () -> importDynamic "./Components/ModalsSample.fsx")

let NavbarSample: obj =
    rl (fun () -> importDynamic "./Components/NavbarSample.fsx")

let NavsSample: obj =
    rl (fun () -> importDynamic "./Components/NavsSample.fsx")

let PaginationSample: obj =
    rl (fun () -> importDynamic "./Components/PaginationSample.fsx")

let PopoversSample: obj =
    rl (fun () -> importDynamic "./Components/PopoversSample.fsx")

let ProgressSample: obj =
    rl (fun () -> importDynamic "./Components/ProgressSample.fsx")

let SpinnersSample: obj =
    rl (fun () -> importDynamic "./Components/SpinnersSample.fsx")

let TablesSample: obj =
    rl (fun () -> importDynamic "./Components/TablesSample.fsx")

let TabsSample: obj =
    rl (fun () -> importDynamic "./Components/TabsSample.fsx")

let ToastsSample: obj =
    rl (fun () -> importDynamic "./Components/ToastsSample.fsx")

let TooltipsSample: obj =
    rl (fun () -> importDynamic "./Components/TooltipsSample.fsx")
...
let routes =
    createObj [ "/"
                ...
                ==> fun _ ->
                    showComponent
                        ButtonDropdownSample
                        (importDefault "!!raw-loader!./Components/ButtonDropdownSample.fsx")
                ...
                ==> fun _ ->
                    showComponent DropdownsSample (importDefault "!!raw-loader!./Components/DropdownsSample.fsx")
                "/components/fade"
                ...
                ==> fun _ ->
                    showComponent InputGroupSample (importDefault "!!raw-loader!./Components/InputGroupSample.fsx")
                "/components/jumbotron"
                ==> fun _ ->
                    showComponent JumbotronSample (importDefault "!!raw-loader!./Components/JumbotronSample.fsx")
                "/components/layout"
                ==> fun _ -> showComponent LayoutSample (importDefault "!!raw-loader!./Components/LayoutSample.fsx")
                "/components/list-group"
                ==> fun _ ->
                    showComponent ListGroupSample (importDefault "!!raw-loader!./Components/ListGroupSample.fsx")
                "/components/media"
                ...
                ==> fun _ ->
                    showComponent PaginationSample (importDefault "!!raw-loader!./Components/PaginationSample.fsx")
                "/components/popovers"
...
let routeUrls =
    Fable.Core.JS.Constructors.Object.keys (routes)
...
let urlToName (url: string) =
    url
        .Replace("/fable-reactstrap/components/", "")
        .Replace("/components/", "")
        .Split('-')
...
let layout path body =
    let menuItems =
        ...
        |> Seq.map (fun url ->
            let className =
                if url = path then "nav-link active" else "nav-link"
    ...
    fragment [] [
        Nav.nav [ Nav.Navbar true
                  Nav.Custom([ ClassName "navbar navbar-expand-md navbar-light header" ]) ] [
            Container.container [] [
                A [ AProps.Href homeRoute
                    AProps.ClassName "mr-auto navbrand-bar" ] [
                    str "Fable Reactstrap"
                ]
                div [ ClassName "collapse navbar-collapse" ] [
                    Navbar.navbar [ Navbar.Custom([ ClassName "ml-sm-auto" ]) ] [
                        NavItem.navItem [] [
                            a [ Href "https://github.com/nojaf/fable-reactstrap"
                                Target "_blank" ] [
                                str "GitHub"
                            ]
                        ]
        ...
        Container.container [] [
            Row.row [] [
                Col.col [ Col.Md(Col.mkCol !^3 |> Col.withOrder !^2)
                          Col.Tag !^ "main" ] [
                ...
                Col.col [ Col.Md(Col.mkCol !^9 |> Col.withOrder !^1)
                          Col.Tag !^ "aside" ] [
                    h2 [ ClassName "h3" ] [
                        str activePageName
                    ]
