...
let routes =
    createObj [
        ...
        "/components/buttons" ==> fun _ -> showComponent ButtonsSample (importDefault "!!raw-loader!./Components/ButtonsSample.fsx")
        "/components/card" ==> fun _ -> showComponent CardSample (importDefault "!!raw-loader!./Components/CardSample.fsx")
        "/components/carousel" ==> fun _ -> showComponent CarouselSample (importDefault "!!raw-loader!./Components/CarouselSample.fsx")
        "/components/collapse" ==> fun _ -> showComponent CollapseSample (importDefault "!!raw-loader!./Components/CollapseSample.fsx")
        ...
        "/components/media" ==> fun _ -> showComponent MediaSample (importDefault "!!raw-loader!./Components/MediaSample.fsx")
        "/components/modals" ==> fun _ -> showComponent ModalsSample (importDefault "!!raw-loader!./Components/ModalsSample.fsx")
        "/components/navbar" ==> fun _ -> showComponent NavbarSample (importDefault "!!raw-loader!./Components/NavbarSample.fsx")
        "/components/navs" ==> fun _ -> showComponent NavsSample (importDefault "!!raw-loader!./Components/NavsSample.fsx")
        "/components/pagination" ==> fun _ -> showComponent PaginationSample (importDefault "!!raw-loader!./Components/PaginationSample.fsx")
        "/components/popovers" ==> fun _ -> showComponent PopoversSample (importDefault "!!raw-loader!./Components/PopoversSample.fsx")
        "/components/progress" ==> fun _ -> showComponent ProgressSample (importDefault "!!raw-loader!./Components/ProgressSample.fsx")
        "/components/spinners" ==> fun _ -> showComponent SpinnersSample (importDefault "!!raw-loader!./Components/SpinnersSample.fsx")
        "/components/tables" ==> fun _ -> showComponent TablesSample (importDefault "!!raw-loader!./Components/TablesSample.fsx")
        "/components/tabs" ==> fun _ -> showComponent TabsSample (importDefault "!!raw-loader!./Components/TabsSample.fsx")
        "/components/toasts" ==> fun _ -> showComponent ToastsSample (importDefault "!!raw-loader!./Components/ToastsSample.fsx")
        "/components/tooltips" ==> fun _ -> showComponent TooltipsSample (importDefault "!!raw-loader!./Components/TooltipsSample.fsx")
    ]
